...
/**
 * Shows the print preview of a specified document
 * @author Timo Dreier
 **/
public class ShowPreview
{
  /**
   * shows a print preview of a specified document
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.out.println("M/TEXT client api example: ShowPreview");
            System.out.println();
            System.out.println("Usage: java mtext.examples.ShowPreview " +
